            ...
            <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <ul className="navbar-nav ml-auto">
                        ...
                        <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a className="dropdown-item d-flex align-items-center" href="#">
                                <div className="dropdown-list-image mr-3">
                                    <img className="rounded-circle" src="image/image-1.svg" alt="..." />
                    ...
                    <li className="nav-item dropdown no-arrow">
                        <Dropdown>
                            <Dropdown.Toggle variant="primary" className='mt-3' id="dropdown-basic">
                                <span className="mr-2 d-none d-lg-inline text-white-600 small">Douglas McGee</span>
                                <img className="img-profile rounded-circle" src="/image/image-1.jpg" />
                            </Dropdown.Toggle>
                            <Dropdown.Menu>
